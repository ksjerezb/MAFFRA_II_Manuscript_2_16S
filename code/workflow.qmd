...
my_pigs=unique(saminfo[which(saminfo$Source!=c("faecal")&saminfo$Source!=c("Control")),"PigID"])

## Seperate out relevant datasets
phylo <- subset_samples(phylo, Day %in% c("21","30"))
phylo <- subset_samples(phylo, PigID %in% my_pigs)
